...
namespace AspNetIdentityRoles.Models
{
    public class IdentityManager
    {
        ...
        public bool CreateRole(string name, string category = "", string description = "")
        {
            // Swap ApplicationRole for IdentityRole:
            var idResult = _roleManager.Create(new ApplicationRole(name, category, description));
        ...
        public void ClearUserRoles(string userId)
        {
            ...
            foreach (var role in currentRoles)
            {
                ...
                //Microsoft.AspNet.Identity.EntityFramework ver 1.0
